...
class TestFooter:
    ...
    # In the following test we check both result on print and return. Other tests only check the return value
    ...
    def test_print_pages_default_tests(
        self, current_page, total_pages, boundaries, around, expected_output, capsys
    ):
    ...
    def test_print_pages_corner_cases(
        self, current_page, total_pages, boundaries, around, expected_output
    ):
    ...
    def test_print_pages_border_values(
        self, current_page, total_pages, boundaries, around, expected_output
    ):
    ...
    def test_print_pages_not_int_values(
        self, current_page, total_pages, boundaries, around, error_message
    ):
    ...
    def test_print_pages_negative_values(
        self, current_page, total_pages, boundaries, around, error_message
    ):
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                1,
                2,
                ERROR_MESSAGES["current_outside_range"].format(current_page=10, total_pages=9),
            ),
            (
                10,
                0,
                1,
                2,
                ERROR_MESSAGES["current_outside_range"].format(current_page=10, total_pages=0),
            ),
            (
                0,
                10,
                1,
                2,
                ERROR_MESSAGES["current_outside_range"].format(current_page=0, total_pages=10),
            ),
        ],
    )
    def test_print_pages_outside_of_total(
        self, current_page, total_pages, boundaries, around, error_message
    ):
    ...
    def test_print_pages_exceed_boundaries(
        self, current_page, total_pages, boundaries, around, error_message
    ):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                5,
                10,
                MAX_BOUNDARIES_AROUND + 1,
                2,
                "Validation error: " + ERROR_MESSAGES["boundaries_around_exceeded"],
            ),
            (
                5,
                MAX_TOTAL_PAGES + 1,
                1,
                2,
                "Validation error: " + ERROR_MESSAGES["maximum_total_exceeded"],
            ),
            (5.5, 10, 6, 2, "Validation error: " + ERROR_MESSAGES["not_int"]),
        ],
    )
    def test_print_pages_validation_errors(
        self, current_page, total_pages, boundaries, around, error_message, capsys
    ):
